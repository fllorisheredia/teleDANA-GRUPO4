      ...
      <div class="flex items-center justify-between">
         <div class="flex items-center justify-start rtl:justify-end">
            ...
            <a href="https://flowbite.com" class="flex ms-2 md:me-24">
               <img src="/teleDANA3/imagenes/logo5.png" class="h-8 me-3" alt="FlowBite Logo" />
               <span
                  class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Reconstruim</span>
            </a>
         </div>
...
<aside id="logo-sidebar"
   ...
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
         ...
         <!-- <li>
            <a id="visor" <a href="#" onclick="cargarPagina('usuarios.php')">
            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <a href="#" onclick="cargarPagina('usuarios2.php')"
               class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <svg class="shrink-0 w-5 h-5 text-gray-500 ...">...</svg>
               <span class="flex-1 ms-3 whitespace-nowrap">Usuarios</span>
            </a>
         </li>
         ...
         <li>
            <a id="visor" href="#"
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Incidencia</span>
            </a>
         </li>
         <li>
            <a id=" visor" href=" "
